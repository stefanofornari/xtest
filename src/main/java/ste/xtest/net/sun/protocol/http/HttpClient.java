...
import static ste.xtest.net.sun.protocol.http.HttpURLConnection.TunnelState.TUNNELING;
import ste.xtest.net.sun.www.ChunkedInputStream;
import ste.xtest.net.sun.www.HeaderParser;
import ste.xtest.net.sun.www.HttpCapture;
import ste.xtest.net.sun.www.HttpCaptureInputStream;
import ste.xtest.net.sun.www.HttpCaptureOutputStream;
...
public class HttpClient extends NetworkClient {
    ...
    private static final Logger logger = HttpURLConnection.getHttpLogger();
    ...
    static {
        SystemConfiguration props = new SystemConfiguration();
        String keepAlive = props.getString("http.keepAlive");
        String retryPost = props.getString("sun.net.http.retryPost");
        String cacheNTLM = props.getString("jdk.ntlm.cache");
        String cacheSPNEGO = props.getString("jdk.spnego.cache");
    ...
    protected synchronized void openServer() throws IOException {
        ...
        if (url.getProtocol().equals("http") ||
            ...
            if ((proxy != null) && (proxy.type() == Proxy.Type.HTTP)) {
                ste.xtest.net.sun.www.URLConnection.setProxiedHost(host);
