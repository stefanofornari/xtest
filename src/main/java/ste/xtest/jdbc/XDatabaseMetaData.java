...
public final class XDatabaseMetaData implements java.sql.DatabaseMetaData {
    ...
    public ResultSet getProcedures(final String catalog,
        ...
        return new RowList(String.class, String.class, String.class,
    ...
    public ResultSet getSchemas() throws SQLException {
        return new RowList(String.class, String.class).
    ...
    public ResultSet getCatalogs() throws SQLException {
        return new RowList(String.class).
            withLabel(1, "TABLE_CAT");
    ...
    public ResultSet getBestRowIdentifier(final String catalog,
        ...
        return new RowList(Short.class, String.class, Integer.class,
                                 String.class, Integer.class, Integer.class,
    ...
    public ResultSet getTypeInfo() throws SQLException {
        return new RowList(String.class, Integer.class, Integer.class,
                                  String.class, String.class, String.class,
    ...
    public ResultSet getClientInfoProperties() throws SQLException {
        return new RowList(String.class, Integer.class,
                                 String.class, String.class).
            withLabel(1, "NAME").
            withLabel(2, "MAX_LEN").
