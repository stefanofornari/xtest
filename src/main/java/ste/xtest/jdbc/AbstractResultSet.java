 ...
 * Base resultset.
 *
 * TODO: fetchSize implementation is incorrect; as per JDBC spec the fetch size
 * does not represent the number of rows in the result set like in this
 * implementation, but rather an hint to the driver on how many rows to fetch
 * when more rows are needed. if fetchSize is 0 it should be ignored.
 *
...
public abstract class AbstractResultSet implements java.sql.ResultSet {
    ...
    public boolean relative(final int rows) throws SQLException {
        ...
        return absolute(this.currentRow + rows);
    } // end of relative
