 ...
 */
public class XConnection implements java.sql.Connection {
    // --- Properties ---
     ...
     */
    private int transactionIsolation = XConnection.TRANSACTION_NONE;
     ...
     * @see Driver#connect
     */
    public XConnection(final String url,
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        ...
        return new ste.xtest.jdbc.
            XCallableStatement(this, sql, Statement.RETURN_GENERATED_KEYS,
    ...
    public DatabaseMetaData getMetaData() throws SQLException {
        ...
        return new ste.xtest.jdbc.XDatabaseMetaData(this);
    } // end of getMetaData
    ...
    public void setTypeMap(final Map<String, Class<?>> typemap)
        ...
        if (typemap == null) {
            throw new SQLException("typemap can not be null");
        } // end of if
    ...
    public Savepoint setSavepoint() throws SQLException {
        ...
        return (this.savepoint = new ste.xtest.jdbc.XSavepoint());
    } // end of setSavepoint
    ...
    public Savepoint setSavepoint(final String name) throws SQLException {
        ...
        return (this.savepoint = new ste.xtest.jdbc.XSavepoint(name));
    } // end of setSavepoint
    ...
    public PreparedStatement prepareStatement(final String sql,
        ...
        return new ste.xtest.jdbc.
            XPreparedStatement(this, sql, autoGeneratedKeys, null, null,
                              this.handler.getStatementHandler());
    ...
    public PreparedStatement prepareStatement(final String sql,
        ...
        return new ste.xtest.jdbc.
            XPreparedStatement(this, sql, Statement.RETURN_GENERATED_KEYS,
                              null, columnIndexes,
                              this.handler.getStatementHandler());
    ...
    public Blob createBlob() throws SQLException {
        return ste.xtest.jdbc.XBlob.Nil();
    } // end of createBlob
    ...
    public Array createArrayOf(final String typeName,
        ...
        final String jdbcClassName = Defaults.jdbcTypeNameClasses.get(JDBCType.valueOf(typeName));
    ...
    public void abort(final Executor exec) throws SQLException {
        if (exec == null) {
            throw new SQLException("exec can not be null");
        } // end of if
