...
public final class XDriver implements java.sql.Driver {
    ...
    /**
     * Connection property to allow untyped null statement parameters
     */
    public static final String CONNECTION_UNTYPED_NULL_PARAMETER = "ste.xtest.jdbc.parameter.untypedNull";
    ...
    public boolean acceptsURL(final String url) throws SQLException {
        return (url != null && url.startsWith("jdbc:xtest:"));
    } // end of acceptsUrl
     ...
     * @return Handler previously registered for |id|, or null if none
     * @throws IllegalArgumentException if |id| or |handler| is null (or empty)
     * @see #register(java.lang.String,ste.xtest.jdbc.ConnectionHandler)
     * @see #unregister
     */
    public static ConnectionHandler register(final String id,
