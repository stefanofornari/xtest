 ...
 */
abstract class XStatement implements java.sql.Statement {
    // --- Shared ---
     ...
     */
    protected static final RowList EMPTY_GENERATED_KEYS = RowLists.stringList();
     ...
     */
    protected XStatement(final ste.xtest.jdbc.XConnection connection,
    ...
    public ResultSet executeQuery(final String sql) throws SQLException {
        ...
        try {
            final QueryResult res = handler.whenSQLQuery(sql, NO_PARAMS);
    ...
    public int executeUpdate(final String sql, final int autoGeneratedKeys)
        throws SQLException {
        reset(); update(sql, autoGeneratedKeys);
     ...
     */
    private void update(final String sql, final int autoGeneratedKeys) throws SQLException {
        ...
        try {
            ...
            generatedKeys = (res.generatedKeys == null
                ...
                ? EMPTY_GENERATED_KEYS.withStatement(this)
                : res.generatedKeys.withStatement(this);
