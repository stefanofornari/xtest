...
import static ste.xtest.jdbc.ParameterMetaData.ParameterDef;
...
public final class CallableStatement
    ...
    protected CallableStatement(final ste.xtest.jdbc.Connection connection,
        ...
        super(connection, sql, generatedKeys, null, null, handler);
    } // end of <init>
    ...
    public void registerOutParameter(final int parameterIndex,
        ...
        indexedOut.put(parameterIndex, Default(JDBCType.valueOf(sqlType)));
    ...
    public void registerOutParameter(final int parameterIndex,
        ...
        indexedOut.put(parameterIndex, Scaled(JDBCType.valueOf(sqlType), scale));
    } // end of registerOutParameter
    ...
    public void registerOutParameter(final String parameterName,
        ...
        this.namedOut.put(parameterName, Default(JDBCType.valueOf(sqlType)));
    } // end of registerOutParameter
    ...
    public void registerOutParameter(final String parameterName,
        ...
        this.namedOut.put(parameterName, Scaled(JDBCType.valueOf(sqlType), scale));
    } // end of registerOutParameter
