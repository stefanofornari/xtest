...
public class BugFreeThen extends ApplicationTest {
    ...
    @Test
    public void find_exactly_one_widget() throws Exception {
    ...
    @Test
    public void find_n_widget() throws Exception {
    ...
    @Test
    public void find_at_least_one_widget() throws Exception {
    ...
    @Test
    public void find_no_widgets() throws Exception {
